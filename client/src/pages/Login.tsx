...
export default function Login() {
  ...
  // ✔ Updated login form to use email (not username)
  const [loginForm, setLoginForm] = useState({ email: "", password: "" });

  // ✔ Register form: username + role removed (backend does not support them)
      ...
      <Card className="w-full max-w-md shadow-xl border-border/50 relative z-10">
        <CardHeader className="space-y-4 flex flex-col items-center text-center pt-10">
          ...
          <div className="space-y-2">
            ...
            <CardDescription>CA Practice Management System</CardDescription>
          </div>
        </CardHeader>
            ...
            <TabsContent value="register">
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                {registerForm.role === "staff" && (
                  <div className="space-y-2">
                    <Label htmlFor="register-admin-email">Admin's Email</Label>
                    <Input
